...
H_file = h5py.File('./NLOS_64x7_52RB_slow_speed_normal.hdf5','r')
...
G_file = h5py.File('./NLOS_64x7_52RB_slow_group_label.hdf5','r')
group_idx = np.array(G_file.get('group_label'))
...
# Agent
agent_1 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_2 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_3 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_4 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_5 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_6 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_7 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_8 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_9 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_10 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)

agent_11 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_12 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_13 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_14 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_15 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_16 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_17 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_18 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_19 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_20 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)

agent_21 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_22 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_23 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_24 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_25 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_26 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_27 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_28 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_29 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_30 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)

agent_31 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_32 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_33 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_34 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_35 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_36 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_37 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_38 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_39 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_40 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)

agent_41 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_42 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_43 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_44 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_45 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_46 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_47 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_48 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_49 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_50 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_51 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
agent_52 = SAC(num_states, num_actions, max_actions, args, 0.0003, 0.0001)
...
memory_51 = ReplayMemory(args.replay_size, args.seed)
memory_52 = ReplayMemory(args.replay_size, args.seed)
...
history_record = np.zeros((1000,num_ue))
ue_history = 0.01 * np.ones((52,num_ue))
...
for i_episode in range (0,1): 
    episode_reward = np.zeros((52,))
    episode_steps = 0
    done = False
    # ue_ep_history = np.zeros((1000,num_ue))
    # ue_history = 0.01*np.ones((num_ue,))
    # ckpt_path_1 = "checkpoints/sac_checkpoint_16_4_16_vanilla_2RBmob_sep_"
    ckpt_path_1 = "checkpoints/sac_checkpoint_LOS_64x7_slow_speed_"
    ...
    agent_51.load_checkpoint(ckpt_path_1)
    agent_52.load_checkpoint(ckpt_path_1)

    state_1 = np.concatenate((np.reshape(se_max_ur[0,0,:],(1,num_ue)),np.reshape(ue_history[0,:],(1,num_ue)),np.reshape(group_idx[0,0,:],(1,-1))),axis = 1)
    state_2 = np.concatenate((np.reshape(se_max_ur[1,0,:],(1,num_ue)),np.reshape(ue_history[1,:],(1,num_ue)),np.reshape(group_idx[1,0,:],(1,-1))),axis = 1)
    state_3 = np.concatenate((np.reshape(se_max_ur[2,0,:],(1,num_ue)),np.reshape(ue_history[2,:],(1,num_ue)),np.reshape(group_idx[2,0,:],(1,-1))),axis = 1)
    state_4 = np.concatenate((np.reshape(se_max_ur[3,0,:],(1,num_ue)),np.reshape(ue_history[3,:],(1,num_ue)),np.reshape(group_idx[3,0,:],(1,-1))),axis = 1)
    state_5 = np.concatenate((np.reshape(se_max_ur[4,0,:],(1,num_ue)),np.reshape(ue_history[4,:],(1,num_ue)),np.reshape(group_idx[4,0,:],(1,-1))),axis = 1)
    state_6 = np.concatenate((np.reshape(se_max_ur[5,0,:],(1,num_ue)),np.reshape(ue_history[5,:],(1,num_ue)),np.reshape(group_idx[5,0,:],(1,-1))),axis = 1)
    state_7 = np.concatenate((np.reshape(se_max_ur[6,0,:],(1,num_ue)),np.reshape(ue_history[6,:],(1,num_ue)),np.reshape(group_idx[6,0,:],(1,-1))),axis = 1)
    state_8 = np.concatenate((np.reshape(se_max_ur[7,0,:],(1,num_ue)),np.reshape(ue_history[7,:],(1,num_ue)),np.reshape(group_idx[7,0,:],(1,-1))),axis = 1)
    state_9 = np.concatenate((np.reshape(se_max_ur[8,0,:],(1,num_ue)),np.reshape(ue_history[8,:],(1,num_ue)),np.reshape(group_idx[8,0,:],(1,-1))),axis = 1)
    state_10 = np.concatenate((np.reshape(se_max_ur[9,0,:],(1,num_ue)),np.reshape(ue_history[9,:],(1,num_ue)),np.reshape(group_idx[9,0,:],(1,-1))),axis = 1)

    state_11 = np.concatenate((np.reshape(se_max_ur[10,0,:],(1,num_ue)),np.reshape(ue_history[10,:],(1,num_ue)),np.reshape(group_idx[10,0,:],(1,-1))),axis = 1)
    state_12 = np.concatenate((np.reshape(se_max_ur[11,0,:],(1,num_ue)),np.reshape(ue_history[11,:],(1,num_ue)),np.reshape(group_idx[11,0,:],(1,-1))),axis = 1)
    state_13 = np.concatenate((np.reshape(se_max_ur[12,0,:],(1,num_ue)),np.reshape(ue_history[12,:],(1,num_ue)),np.reshape(group_idx[12,0,:],(1,-1))),axis = 1)
    state_14 = np.concatenate((np.reshape(se_max_ur[13,0,:],(1,num_ue)),np.reshape(ue_history[13,:],(1,num_ue)),np.reshape(group_idx[13,0,:],(1,-1))),axis = 1)
    state_15 = np.concatenate((np.reshape(se_max_ur[14,0,:],(1,num_ue)),np.reshape(ue_history[14,:],(1,num_ue)),np.reshape(group_idx[14,0,:],(1,-1))),axis = 1)
    state_16 = np.concatenate((np.reshape(se_max_ur[15,0,:],(1,num_ue)),np.reshape(ue_history[15,:],(1,num_ue)),np.reshape(group_idx[15,0,:],(1,-1))),axis = 1)
    state_17 = np.concatenate((np.reshape(se_max_ur[16,0,:],(1,num_ue)),np.reshape(ue_history[16,:],(1,num_ue)),np.reshape(group_idx[16,0,:],(1,-1))),axis = 1)
    state_18 = np.concatenate((np.reshape(se_max_ur[17,0,:],(1,num_ue)),np.reshape(ue_history[17,:],(1,num_ue)),np.reshape(group_idx[17,0,:],(1,-1))),axis = 1)
    state_19 = np.concatenate((np.reshape(se_max_ur[18,0,:],(1,num_ue)),np.reshape(ue_history[18,:],(1,num_ue)),np.reshape(group_idx[18,0,:],(1,-1))),axis = 1)
    state_20 = np.concatenate((np.reshape(se_max_ur[19,0,:],(1,num_ue)),np.reshape(ue_history[19,:],(1,num_ue)),np.reshape(group_idx[19,0,:],(1,-1))),axis = 1)

    state_21 = np.concatenate((np.reshape(se_max_ur[20,0,:],(1,num_ue)),np.reshape(ue_history[20,:],(1,num_ue)),np.reshape(group_idx[20,0,:],(1,-1))),axis = 1)
    state_22 = np.concatenate((np.reshape(se_max_ur[21,0,:],(1,num_ue)),np.reshape(ue_history[21,:],(1,num_ue)),np.reshape(group_idx[21,0,:],(1,-1))),axis = 1)
    state_23 = np.concatenate((np.reshape(se_max_ur[22,0,:],(1,num_ue)),np.reshape(ue_history[22,:],(1,num_ue)),np.reshape(group_idx[22,0,:],(1,-1))),axis = 1)
    state_24 = np.concatenate((np.reshape(se_max_ur[23,0,:],(1,num_ue)),np.reshape(ue_history[23,:],(1,num_ue)),np.reshape(group_idx[23,0,:],(1,-1))),axis = 1)
    state_25 = np.concatenate((np.reshape(se_max_ur[24,0,:],(1,num_ue)),np.reshape(ue_history[24,:],(1,num_ue)),np.reshape(group_idx[24,0,:],(1,-1))),axis = 1)
    state_26 = np.concatenate((np.reshape(se_max_ur[25,0,:],(1,num_ue)),np.reshape(ue_history[25,:],(1,num_ue)),np.reshape(group_idx[25,0,:],(1,-1))),axis = 1)
    state_27 = np.concatenate((np.reshape(se_max_ur[26,0,:],(1,num_ue)),np.reshape(ue_history[26,:],(1,num_ue)),np.reshape(group_idx[26,0,:],(1,-1))),axis = 1)
    state_28 = np.concatenate((np.reshape(se_max_ur[27,0,:],(1,num_ue)),np.reshape(ue_history[27,:],(1,num_ue)),np.reshape(group_idx[27,0,:],(1,-1))),axis = 1)
    state_29 = np.concatenate((np.reshape(se_max_ur[28,0,:],(1,num_ue)),np.reshape(ue_history[28,:],(1,num_ue)),np.reshape(group_idx[28,0,:],(1,-1))),axis = 1)
    state_30 = np.concatenate((np.reshape(se_max_ur[29,0,:],(1,num_ue)),np.reshape(ue_history[29,:],(1,num_ue)),np.reshape(group_idx[29,0,:],(1,-1))),axis = 1)

    state_31 = np.concatenate((np.reshape(se_max_ur[30,0,:],(1,num_ue)),np.reshape(ue_history[30,:],(1,num_ue)),np.reshape(group_idx[30,0,:],(1,-1))),axis = 1)
    state_32 = np.concatenate((np.reshape(se_max_ur[31,0,:],(1,num_ue)),np.reshape(ue_history[31,:],(1,num_ue)),np.reshape(group_idx[31,0,:],(1,-1))),axis = 1)
    state_33 = np.concatenate((np.reshape(se_max_ur[32,0,:],(1,num_ue)),np.reshape(ue_history[32,:],(1,num_ue)),np.reshape(group_idx[32,0,:],(1,-1))),axis = 1)
    state_34 = np.concatenate((np.reshape(se_max_ur[33,0,:],(1,num_ue)),np.reshape(ue_history[33,:],(1,num_ue)),np.reshape(group_idx[33,0,:],(1,-1))),axis = 1)
    state_35 = np.concatenate((np.reshape(se_max_ur[34,0,:],(1,num_ue)),np.reshape(ue_history[34,:],(1,num_ue)),np.reshape(group_idx[34,0,:],(1,-1))),axis = 1)
    state_36 = np.concatenate((np.reshape(se_max_ur[35,0,:],(1,num_ue)),np.reshape(ue_history[35,:],(1,num_ue)),np.reshape(group_idx[35,0,:],(1,-1))),axis = 1)
    state_37 = np.concatenate((np.reshape(se_max_ur[36,0,:],(1,num_ue)),np.reshape(ue_history[36,:],(1,num_ue)),np.reshape(group_idx[36,0,:],(1,-1))),axis = 1)
    state_38 = np.concatenate((np.reshape(se_max_ur[37,0,:],(1,num_ue)),np.reshape(ue_history[37,:],(1,num_ue)),np.reshape(group_idx[37,0,:],(1,-1))),axis = 1)
    state_39 = np.concatenate((np.reshape(se_max_ur[38,0,:],(1,num_ue)),np.reshape(ue_history[38,:],(1,num_ue)),np.reshape(group_idx[38,0,:],(1,-1))),axis = 1)
    state_40 = np.concatenate((np.reshape(se_max_ur[39,0,:],(1,num_ue)),np.reshape(ue_history[39,:],(1,num_ue)),np.reshape(group_idx[39,0,:],(1,-1))),axis = 1)

    state_41 = np.concatenate((np.reshape(se_max_ur[40,0,:],(1,num_ue)),np.reshape(ue_history[40,:],(1,num_ue)),np.reshape(group_idx[40,0,:],(1,-1))),axis = 1)
    state_42 = np.concatenate((np.reshape(se_max_ur[41,0,:],(1,num_ue)),np.reshape(ue_history[41,:],(1,num_ue)),np.reshape(group_idx[41,0,:],(1,-1))),axis = 1)
    state_43 = np.concatenate((np.reshape(se_max_ur[42,0,:],(1,num_ue)),np.reshape(ue_history[42,:],(1,num_ue)),np.reshape(group_idx[42,0,:],(1,-1))),axis = 1)
    state_44 = np.concatenate((np.reshape(se_max_ur[43,0,:],(1,num_ue)),np.reshape(ue_history[43,:],(1,num_ue)),np.reshape(group_idx[43,0,:],(1,-1))),axis = 1)
    state_45 = np.concatenate((np.reshape(se_max_ur[44,0,:],(1,num_ue)),np.reshape(ue_history[44,:],(1,num_ue)),np.reshape(group_idx[44,0,:],(1,-1))),axis = 1)
    state_46 = np.concatenate((np.reshape(se_max_ur[45,0,:],(1,num_ue)),np.reshape(ue_history[45,:],(1,num_ue)),np.reshape(group_idx[45,0,:],(1,-1))),axis = 1)
    state_47 = np.concatenate((np.reshape(se_max_ur[46,0,:],(1,num_ue)),np.reshape(ue_history[46,:],(1,num_ue)),np.reshape(group_idx[46,0,:],(1,-1))),axis = 1)
    state_48 = np.concatenate((np.reshape(se_max_ur[47,0,:],(1,num_ue)),np.reshape(ue_history[47,:],(1,num_ue)),np.reshape(group_idx[47,0,:],(1,-1))),axis = 1)
    state_49 = np.concatenate((np.reshape(se_max_ur[48,0,:],(1,num_ue)),np.reshape(ue_history[48,:],(1,num_ue)),np.reshape(group_idx[48,0,:],(1,-1))),axis = 1)
    state_50 = np.concatenate((np.reshape(se_max_ur[49,0,:],(1,num_ue)),np.reshape(ue_history[49,:],(1,num_ue)),np.reshape(group_idx[49,0,:],(1,-1))),axis = 1)
    state_51 = np.concatenate((np.reshape(se_max_ur[50,0,:],(1,num_ue)),np.reshape(ue_history[50,:],(1,num_ue)),np.reshape(group_idx[50,0,:],(1,-1))),axis = 1)
    state_52 = np.concatenate((np.reshape(se_max_ur[51,0,:],(1,num_ue)),np.reshape(ue_history[51,:],(1,num_ue)),np.reshape(group_idx[51,0,:],(1,-1))),axis = 1)
    ...
    while not done:
        ...
        if random > np.random.rand(1):
            ...
            action_51, final_action_51 = agent_51.random_action()
            action_52, final_action_52 = agent_52.random_action()
            ...
            action_51, final_action_51 = agent_51.select_action(state_51)
            action_52, final_action_52 = agent_52.select_action(state_52)
            print('Actor action')
        ...
        ue_select_51,idx_51 = sel_ue(final_action_51[0])
        ue_select_52,idx_52 = sel_ue(final_action_52[0])
        ...
        mod_select_51 = np.ones((idx_51,)) *16 # 16-QAM
        ur_se_total_51, ur_min_snr_51, ur_se_51 = data_process(np.reshape(H_c[50,episode_steps,:,ue_select_51],(num_bs,-1)),idx_51,mod_select_51)
        ur_se_total_51 = ur_se_total_51/normal_ur[50,episode_steps]

        mod_select_52 = np.ones((idx_52,)) *16
        ur_se_total_52, ur_min_snr_52, ur_se_52 = data_process(np.reshape(H_c[51,episode_steps,:,ue_select_52],(num_bs,-1)),idx_52,mod_select_52)
        ur_se_total_52 = ur_se_total_52/normal_ur[51,episode_steps]

        for i in range(0,idx_1):
            ue_history[0,ue_select_1[i]] += ur_se_1[i]
        for i in range(0,idx_2):
            ue_history[1,ue_select_2[i]] += ur_se_2[i]
        for i in range(0,idx_3):
            ue_history[2,ue_select_3[i]] += ur_se_3[i]
        for i in range(0,idx_4):
            ue_history[3,ue_select_4[i]] += ur_se_4[i]
        for i in range(0,idx_5):
            ue_history[4,ue_select_5[i]] += ur_se_5[i]
        for i in range(0,idx_6):
            ue_history[5,ue_select_6[i]] += ur_se_6[i]
        for i in range(0,idx_7):
            ue_history[6,ue_select_7[i]] += ur_se_7[i]
        for i in range(0,idx_8):
            ue_history[7,ue_select_8[i]] += ur_se_8[i]
        for i in range(0,idx_9):
            ue_history[8,ue_select_9[i]] += ur_se_9[i]
        for i in range(0,idx_10):
            ue_history[9,ue_select_10[i]] += ur_se_10[i]

        for i in range(0,idx_11):
            ue_history[10,ue_select_11[i]] += ur_se_11[i]
        for i in range(0,idx_12):
            ue_history[11,ue_select_12[i]] += ur_se_12[i]
        for i in range(0,idx_13):
            ue_history[12,ue_select_13[i]] += ur_se_13[i]
        for i in range(0,idx_14):
            ue_history[13,ue_select_14[i]] += ur_se_14[i]
        for i in range(0,idx_15):
            ue_history[14,ue_select_15[i]] += ur_se_15[i]
        for i in range(0,idx_16):
            ue_history[15,ue_select_16[i]] += ur_se_16[i]
        for i in range(0,idx_17):
            ue_history[16,ue_select_17[i]] += ur_se_17[i]
        for i in range(0,idx_18):
            ue_history[17,ue_select_18[i]] += ur_se_18[i]
        for i in range(0,idx_19):
            ue_history[18,ue_select_19[i]] += ur_se_19[i]
        for i in range(0,idx_20):
            ue_history[19,ue_select_20[i]] += ur_se_20[i]

        for i in range(0,idx_21):
            ue_history[20,ue_select_21[i]] += ur_se_21[i]
        for i in range(0,idx_22):
            ue_history[21,ue_select_22[i]] += ur_se_22[i]
        for i in range(0,idx_23):
            ue_history[22,ue_select_23[i]] += ur_se_23[i]
        for i in range(0,idx_24):
            ue_history[23,ue_select_24[i]] += ur_se_24[i]
        for i in range(0,idx_25):
            ue_history[24,ue_select_25[i]] += ur_se_25[i]
        for i in range(0,idx_26):
            ue_history[25,ue_select_26[i]] += ur_se_26[i]
        for i in range(0,idx_27):
            ue_history[26,ue_select_27[i]] += ur_se_27[i]
        for i in range(0,idx_28):
            ue_history[27,ue_select_28[i]] += ur_se_28[i]
        for i in range(0,idx_29):
            ue_history[28,ue_select_29[i]] += ur_se_29[i]
        for i in range(0,idx_30):
            ue_history[29,ue_select_30[i]] += ur_se_30[i]


        for i in range(0,idx_31):
            ue_history[30,ue_select_31[i]] += ur_se_31[i]
        for i in range(0,idx_32):
            ue_history[31,ue_select_32[i]] += ur_se_32[i]
        for i in range(0,idx_33):
            ue_history[32,ue_select_33[i]] += ur_se_33[i]
        for i in range(0,idx_34):
            ue_history[33,ue_select_34[i]] += ur_se_34[i]
        for i in range(0,idx_35):
            ue_history[34,ue_select_35[i]] += ur_se_35[i]
        for i in range(0,idx_36):
            ue_history[35,ue_select_36[i]] += ur_se_36[i]
        for i in range(0,idx_37):
            ue_history[36,ue_select_37[i]] += ur_se_37[i]
        for i in range(0,idx_38):
            ue_history[37,ue_select_38[i]] += ur_se_38[i]
        for i in range(0,idx_39):
            ue_history[38,ue_select_39[i]] += ur_se_39[i]
        for i in range(0,idx_40):
            ue_history[39,ue_select_40[i]] += ur_se_40[i]


        for i in range(0,idx_41):
            ue_history[40,ue_select_41[i]] += ur_se_41[i]
        for i in range(0,idx_42):
            ue_history[41,ue_select_42[i]] += ur_se_42[i]
        for i in range(0,idx_43):
            ue_history[42,ue_select_43[i]] += ur_se_43[i]
        for i in range(0,idx_44):
            ue_history[43,ue_select_44[i]] += ur_se_44[i]
        for i in range(0,idx_45):
            ue_history[44,ue_select_45[i]] += ur_se_45[i]
        for i in range(0,idx_46):
            ue_history[45,ue_select_46[i]] += ur_se_46[i]
        for i in range(0,idx_47):
            ue_history[46,ue_select_47[i]] += ur_se_47[i]
        for i in range(0,idx_48):
            ue_history[47,ue_select_48[i]] += ur_se_48[i]
        for i in range(0,idx_49):
            ue_history[48,ue_select_49[i]] += ur_se_49[i]
        for i in range(0,idx_50):
            ue_history[49,ue_select_50[i]] += ur_se_50[i]
        for i in range(0,idx_51):
            ue_history[50,ue_select_51[i]] += ur_se_51[i]
        for i in range(0,idx_52):
            ue_history[51,ue_select_52[i]] += ur_se_52[i]

        ue_history_total = np.zeros((num_ue,))
        for i in range (0,52):
             ue_history_total += ue_history[i,:]
        history_record[episode_steps,:] = ue_history_total
        ...
        for i in range (0,52):
            jfi[i] = np.square((np.sum(ue_history[i,:]))) / (num_ue * np.sum(np.square(ue_history[i,:])))
        ...
        next_state_1 = np.concatenate((np.reshape(se_max_ur[0,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[0,:],(1,num_ue)),np.reshape(group_idx[0,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_2 = np.concatenate((np.reshape(se_max_ur[1,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[1,:],(1,num_ue)),np.reshape(group_idx[1,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_3 = np.concatenate((np.reshape(se_max_ur[2,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[2,:],(1,num_ue)),np.reshape(group_idx[2,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_4 = np.concatenate((np.reshape(se_max_ur[3,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[3,:],(1,num_ue)),np.reshape(group_idx[3,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_5 = np.concatenate((np.reshape(se_max_ur[4,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[4,:],(1,num_ue)),np.reshape(group_idx[4,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_6 = np.concatenate((np.reshape(se_max_ur[5,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[5,:],(1,num_ue)),np.reshape(group_idx[5,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_7 = np.concatenate((np.reshape(se_max_ur[6,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[6,:],(1,num_ue)),np.reshape(group_idx[6,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_8 = np.concatenate((np.reshape(se_max_ur[7,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[7,:],(1,num_ue)),np.reshape(group_idx[7,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_9 = np.concatenate((np.reshape(se_max_ur[8,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[8,:],(1,num_ue)),np.reshape(group_idx[8,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_10 = np.concatenate((np.reshape(se_max_ur[9,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[9,:],(1,num_ue)),np.reshape(group_idx[9,(episode_steps+1),:],(1,-1))),axis = 1)

        next_state_11 = np.concatenate((np.reshape(se_max_ur[10,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[10,:],(1,num_ue)),np.reshape(group_idx[10,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_12 = np.concatenate((np.reshape(se_max_ur[11,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[11,:],(1,num_ue)),np.reshape(group_idx[11,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_13 = np.concatenate((np.reshape(se_max_ur[12,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[12,:],(1,num_ue)),np.reshape(group_idx[12,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_14 = np.concatenate((np.reshape(se_max_ur[13,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[13,:],(1,num_ue)),np.reshape(group_idx[13,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_15 = np.concatenate((np.reshape(se_max_ur[14,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[14,:],(1,num_ue)),np.reshape(group_idx[14,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_16 = np.concatenate((np.reshape(se_max_ur[15,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[15,:],(1,num_ue)),np.reshape(group_idx[15,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_17 = np.concatenate((np.reshape(se_max_ur[16,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[16,:],(1,num_ue)),np.reshape(group_idx[16,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_18 = np.concatenate((np.reshape(se_max_ur[17,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[17,:],(1,num_ue)),np.reshape(group_idx[17,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_19 = np.concatenate((np.reshape(se_max_ur[18,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[18,:],(1,num_ue)),np.reshape(group_idx[18,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_20 = np.concatenate((np.reshape(se_max_ur[19,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[19,:],(1,num_ue)),np.reshape(group_idx[19,(episode_steps+1),:],(1,-1))),axis = 1)

        next_state_21 = np.concatenate((np.reshape(se_max_ur[20,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[20,:],(1,num_ue)),np.reshape(group_idx[20,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_22 = np.concatenate((np.reshape(se_max_ur[21,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[21,:],(1,num_ue)),np.reshape(group_idx[21,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_23 = np.concatenate((np.reshape(se_max_ur[22,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[22,:],(1,num_ue)),np.reshape(group_idx[22,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_24 = np.concatenate((np.reshape(se_max_ur[23,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[23,:],(1,num_ue)),np.reshape(group_idx[23,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_25 = np.concatenate((np.reshape(se_max_ur[24,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[24,:],(1,num_ue)),np.reshape(group_idx[24,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_26 = np.concatenate((np.reshape(se_max_ur[25,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[25,:],(1,num_ue)),np.reshape(group_idx[25,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_27 = np.concatenate((np.reshape(se_max_ur[26,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[26,:],(1,num_ue)),np.reshape(group_idx[26,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_28 = np.concatenate((np.reshape(se_max_ur[27,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[27,:],(1,num_ue)),np.reshape(group_idx[27,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_29 = np.concatenate((np.reshape(se_max_ur[28,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[28,:],(1,num_ue)),np.reshape(group_idx[28,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_30 = np.concatenate((np.reshape(se_max_ur[29,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[29,:],(1,num_ue)),np.reshape(group_idx[29,(episode_steps+1),:],(1,-1))),axis = 1)

        next_state_31 = np.concatenate((np.reshape(se_max_ur[30,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[30,:],(1,num_ue)),np.reshape(group_idx[30,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_32 = np.concatenate((np.reshape(se_max_ur[31,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[31,:],(1,num_ue)),np.reshape(group_idx[31,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_33 = np.concatenate((np.reshape(se_max_ur[32,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[32,:],(1,num_ue)),np.reshape(group_idx[32,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_34 = np.concatenate((np.reshape(se_max_ur[33,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[33,:],(1,num_ue)),np.reshape(group_idx[33,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_35 = np.concatenate((np.reshape(se_max_ur[34,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[34,:],(1,num_ue)),np.reshape(group_idx[34,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_36 = np.concatenate((np.reshape(se_max_ur[35,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[35,:],(1,num_ue)),np.reshape(group_idx[35,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_37 = np.concatenate((np.reshape(se_max_ur[36,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[36,:],(1,num_ue)),np.reshape(group_idx[36,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_38 = np.concatenate((np.reshape(se_max_ur[37,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[37,:],(1,num_ue)),np.reshape(group_idx[37,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_39 = np.concatenate((np.reshape(se_max_ur[38,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[38,:],(1,num_ue)),np.reshape(group_idx[38,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_40 = np.concatenate((np.reshape(se_max_ur[39,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[39,:],(1,num_ue)),np.reshape(group_idx[39,(episode_steps+1),:],(1,-1))),axis = 1)

        next_state_41 = np.concatenate((np.reshape(se_max_ur[40,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[40,:],(1,num_ue)),np.reshape(group_idx[40,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_42 = np.concatenate((np.reshape(se_max_ur[41,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[41,:],(1,num_ue)),np.reshape(group_idx[41,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_43 = np.concatenate((np.reshape(se_max_ur[42,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[42,:],(1,num_ue)),np.reshape(group_idx[42,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_44 = np.concatenate((np.reshape(se_max_ur[43,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[43,:],(1,num_ue)),np.reshape(group_idx[43,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_45 = np.concatenate((np.reshape(se_max_ur[44,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[44,:],(1,num_ue)),np.reshape(group_idx[44,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_46 = np.concatenate((np.reshape(se_max_ur[45,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[45,:],(1,num_ue)),np.reshape(group_idx[45,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_47 = np.concatenate((np.reshape(se_max_ur[46,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[46,:],(1,num_ue)),np.reshape(group_idx[46,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_48 = np.concatenate((np.reshape(se_max_ur[47,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[47,:],(1,num_ue)),np.reshape(group_idx[47,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_49 = np.concatenate((np.reshape(se_max_ur[48,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[48,:],(1,num_ue)),np.reshape(group_idx[48,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_50 = np.concatenate((np.reshape(se_max_ur[49,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[49,:],(1,num_ue)),np.reshape(group_idx[49,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_51 = np.concatenate((np.reshape(se_max_ur[50,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[50,:],(1,num_ue)),np.reshape(group_idx[50,(episode_steps+1),:],(1,-1))),axis = 1)
        next_state_52 = np.concatenate((np.reshape(se_max_ur[51,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[51,:],(1,num_ue)),np.reshape(group_idx[51,(episode_steps+1),:],(1,-1))),axis = 1)



        reward_1  = (a*ur_se_total_1 + b*jfi[0])*reward_scale
        reward_2  = (a*ur_se_total_2 + b*jfi[1])*reward_scale
        reward_3  = (a*ur_se_total_3 + b*jfi[2])*reward_scale
        reward_4  = (a*ur_se_total_4 + b*jfi[3])*reward_scale
        reward_5  = (a*ur_se_total_5 + b*jfi[4])*reward_scale
        reward_6  = (a*ur_se_total_6 + b*jfi[5])*reward_scale
        reward_7  = (a*ur_se_total_7 + b*jfi[6])*reward_scale
        reward_8  = (a*ur_se_total_8 + b*jfi[7])*reward_scale
        reward_9  = (a*ur_se_total_9 + b*jfi[8])*reward_scale
        reward_10  = (a*ur_se_total_10 + b*jfi[9])*reward_scale

        reward_11  = (a*ur_se_total_11 + b*jfi[10])*reward_scale
        reward_12  = (a*ur_se_total_12 + b*jfi[11])*reward_scale
        reward_13  = (a*ur_se_total_13 + b*jfi[12])*reward_scale
        reward_14  = (a*ur_se_total_14 + b*jfi[13])*reward_scale
        reward_15  = (a*ur_se_total_15 + b*jfi[14])*reward_scale
        reward_16  = (a*ur_se_total_16 + b*jfi[15])*reward_scale
        reward_17  = (a*ur_se_total_17 + b*jfi[16])*reward_scale
        reward_18  = (a*ur_se_total_18 + b*jfi[17])*reward_scale
        reward_19  = (a*ur_se_total_19 + b*jfi[18])*reward_scale
        reward_20  = (a*ur_se_total_20 + b*jfi[19])*reward_scale

        reward_21  = (a*ur_se_total_21 + b*jfi[20])*reward_scale
        reward_22  = (a*ur_se_total_22 + b*jfi[21])*reward_scale
        reward_23  = (a*ur_se_total_23 + b*jfi[22])*reward_scale
        reward_24  = (a*ur_se_total_24 + b*jfi[23])*reward_scale
        reward_25  = (a*ur_se_total_25 + b*jfi[24])*reward_scale
        reward_26  = (a*ur_se_total_26 + b*jfi[25])*reward_scale
        reward_27  = (a*ur_se_total_27 + b*jfi[26])*reward_scale
        reward_28  = (a*ur_se_total_28 + b*jfi[27])*reward_scale
        reward_29  = (a*ur_se_total_29 + b*jfi[28])*reward_scale
        reward_30  = (a*ur_se_total_30 + b*jfi[29])*reward_scale

        reward_31  = (a*ur_se_total_31 + b*jfi[30])*reward_scale
        reward_32  = (a*ur_se_total_32 + b*jfi[31])*reward_scale
        reward_33  = (a*ur_se_total_33 + b*jfi[32])*reward_scale
        reward_34  = (a*ur_se_total_34 + b*jfi[33])*reward_scale
        reward_35  = (a*ur_se_total_35 + b*jfi[34])*reward_scale
        reward_36  = (a*ur_se_total_36 + b*jfi[35])*reward_scale
        reward_37  = (a*ur_se_total_37 + b*jfi[36])*reward_scale
        reward_38  = (a*ur_se_total_38 + b*jfi[37])*reward_scale
        reward_39  = (a*ur_se_total_39 + b*jfi[38])*reward_scale
        reward_40  = (a*ur_se_total_40 + b*jfi[39])*reward_scale

        reward_41  = (a*ur_se_total_41 + b*jfi[40])*reward_scale
        reward_42  = (a*ur_se_total_42 + b*jfi[41])*reward_scale
        reward_43  = (a*ur_se_total_43 + b*jfi[42])*reward_scale
        reward_44  = (a*ur_se_total_44 + b*jfi[43])*reward_scale
        reward_45  = (a*ur_se_total_45 + b*jfi[44])*reward_scale
        reward_46  = (a*ur_se_total_46 + b*jfi[45])*reward_scale
        reward_47  = (a*ur_se_total_47 + b*jfi[46])*reward_scale
        reward_48  = (a*ur_se_total_48 + b*jfi[47])*reward_scale
        reward_49  = (a*ur_se_total_49 + b*jfi[48])*reward_scale
        reward_50  = (a*ur_se_total_50 + b*jfi[49])*reward_scale
        reward_51  = (a*ur_se_total_51 + b*jfi[50])*reward_scale
        reward_52  = (a*ur_se_total_52 + b*jfi[51])*reward_scale
        ...
        memory_51.push(state_51, action_51, reward_51, next_state_51, mask) # Append transition to memory
        memory_52.push(state_52, action_52, reward_52, next_state_52, mask)
        ...
        state_51 = next_state_51
        state_52 = next_state_52


        end_time = time.time()
        print('Training time is:', (end_time-start_time),"\n")

with h5py.File("./data/NLOS_64x7_52RB_slow_speed_result.hdf5", "w") as data_file:
