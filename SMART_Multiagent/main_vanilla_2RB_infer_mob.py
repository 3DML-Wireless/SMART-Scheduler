...
H_r_1 = np.array(H_file.get('H_r_1'))
H_i_1 = np.array(H_file.get('H_i_1'))
# H_i = np.transpose(H_i,(2,1,0))
# H_r = np.transpose(H_r,(2,1,0))
...
H_r_2 = np.array(H_file.get('H_r_2'))
H_i_2 = np.array(H_file.get('H_i_2'))
# H_i = np.transpose(H_i,(2,1,0))
# H_r = np.transpose(H_r,(2,1,0))
# print("H_r_2 shape is:", H_r_2.shape)
# print("H_i_2 shape is:", H_i_2.shape)
H_2 = np.array(H_r_2 + 1j*H_i_2)
print("H_2 shape is:", H_2.shape)

se_max_ur_1 = np.array(H_file.get('se_max_1'))
print("se_max_ur_1 shape is:", se_max_ur_1.shape)

se_max_ur_2 = np.array(H_file.get('se_max_2'))
print("se_max_ur_2 shape is:", se_max_ur_2.shape)

normal_ur_1 = np.array(H_file.get('normal_1'))
print("normal_ur_1 shape is:", normal_ur_1.shape)

normal_ur_2 = np.array(H_file.get('normal_2'))
...
for i_episode in range (0,1): 
    ...
    ckpt_path_1 = "checkpoints/sac_checkpoint_8_8_2RB_mob_1_5e-5_"
    ckpt_path_2 = "checkpoints/sac_checkpoint_8_8_2RB_mob_2_5e-5_"
...
with h5py.File("./data/8_8_infer_2RBmob_multiagent.hdf5", "w") as data_file:
