...
ue_history = 0.01 * np.ones((50,num_ue))
# for i in range (0,50):
...
for i_episode in range (0,1): 
    ...
    ckpt_path_1 = "checkpoints/sac_checkpoint_8_8_2RB_mob_ind_5e-5_"
    ...
    state_1 = np.concatenate((np.reshape(se_max_ur[0,0,:],(1,num_ue)),np.reshape(ue_history[0,:],(1,num_ue)),np.reshape(H_rc[0,0,:,:],(1,-1)),np.reshape(H_ic[0,0,:,:],(1,-1))),axis = 1)
    state_2 = np.concatenate((np.reshape(se_max_ur[1,0,:],(1,num_ue)),np.reshape(ue_history[1,:],(1,num_ue)),np.reshape(H_rc[1,0,:,:],(1,-1)),np.reshape(H_ic[1,0,:,:],(1,-1))),axis = 1)
    state_3 = np.concatenate((np.reshape(se_max_ur[2,0,:],(1,num_ue)),np.reshape(ue_history[2,:],(1,num_ue)),np.reshape(H_rc[2,0,:,:],(1,-1)),np.reshape(H_ic[2,0,:,:],(1,-1))),axis = 1)
    state_4 = np.concatenate((np.reshape(se_max_ur[3,0,:],(1,num_ue)),np.reshape(ue_history[3,:],(1,num_ue)),np.reshape(H_rc[3,0,:,:],(1,-1)),np.reshape(H_ic[3,0,:,:],(1,-1))),axis = 1)
    state_5 = np.concatenate((np.reshape(se_max_ur[4,0,:],(1,num_ue)),np.reshape(ue_history[4,:],(1,num_ue)),np.reshape(H_rc[4,0,:,:],(1,-1)),np.reshape(H_ic[4,0,:,:],(1,-1))),axis = 1)
    state_6 = np.concatenate((np.reshape(se_max_ur[5,0,:],(1,num_ue)),np.reshape(ue_history[5,:],(1,num_ue)),np.reshape(H_rc[5,0,:,:],(1,-1)),np.reshape(H_ic[5,0,:,:],(1,-1))),axis = 1)
    state_7 = np.concatenate((np.reshape(se_max_ur[6,0,:],(1,num_ue)),np.reshape(ue_history[6,:],(1,num_ue)),np.reshape(H_rc[6,0,:,:],(1,-1)),np.reshape(H_ic[6,0,:,:],(1,-1))),axis = 1)
    state_8 = np.concatenate((np.reshape(se_max_ur[7,0,:],(1,num_ue)),np.reshape(ue_history[7,:],(1,num_ue)),np.reshape(H_rc[7,0,:,:],(1,-1)),np.reshape(H_ic[7,0,:,:],(1,-1))),axis = 1)
    state_9 = np.concatenate((np.reshape(se_max_ur[8,0,:],(1,num_ue)),np.reshape(ue_history[8,:],(1,num_ue)),np.reshape(H_rc[8,0,:,:],(1,-1)),np.reshape(H_ic[8,0,:,:],(1,-1))),axis = 1)
    state_10 = np.concatenate((np.reshape(se_max_ur[9,0,:],(1,num_ue)),np.reshape(ue_history[9,:],(1,num_ue)),np.reshape(H_rc[9,0,:,:],(1,-1)),np.reshape(H_ic[9,0,:,:],(1,-1))),axis = 1)

    state_11 = np.concatenate((np.reshape(se_max_ur[10,0,:],(1,num_ue)),np.reshape(ue_history[10,:],(1,num_ue)),np.reshape(H_rc[10,0,:,:],(1,-1)),np.reshape(H_ic[10,0,:,:],(1,-1))),axis = 1)
    state_12 = np.concatenate((np.reshape(se_max_ur[11,0,:],(1,num_ue)),np.reshape(ue_history[11,:],(1,num_ue)),np.reshape(H_rc[11,0,:,:],(1,-1)),np.reshape(H_ic[11,0,:,:],(1,-1))),axis = 1)
    state_13 = np.concatenate((np.reshape(se_max_ur[12,0,:],(1,num_ue)),np.reshape(ue_history[12,:],(1,num_ue)),np.reshape(H_rc[12,0,:,:],(1,-1)),np.reshape(H_ic[12,0,:,:],(1,-1))),axis = 1)
    state_14 = np.concatenate((np.reshape(se_max_ur[13,0,:],(1,num_ue)),np.reshape(ue_history[13,:],(1,num_ue)),np.reshape(H_rc[13,0,:,:],(1,-1)),np.reshape(H_ic[13,0,:,:],(1,-1))),axis = 1)
    state_15 = np.concatenate((np.reshape(se_max_ur[14,0,:],(1,num_ue)),np.reshape(ue_history[14,:],(1,num_ue)),np.reshape(H_rc[14,0,:,:],(1,-1)),np.reshape(H_ic[14,0,:,:],(1,-1))),axis = 1)
    state_16 = np.concatenate((np.reshape(se_max_ur[15,0,:],(1,num_ue)),np.reshape(ue_history[15,:],(1,num_ue)),np.reshape(H_rc[15,0,:,:],(1,-1)),np.reshape(H_ic[15,0,:,:],(1,-1))),axis = 1)
    state_17 = np.concatenate((np.reshape(se_max_ur[16,0,:],(1,num_ue)),np.reshape(ue_history[16,:],(1,num_ue)),np.reshape(H_rc[16,0,:,:],(1,-1)),np.reshape(H_ic[16,0,:,:],(1,-1))),axis = 1)
    state_18 = np.concatenate((np.reshape(se_max_ur[17,0,:],(1,num_ue)),np.reshape(ue_history[17,:],(1,num_ue)),np.reshape(H_rc[17,0,:,:],(1,-1)),np.reshape(H_ic[17,0,:,:],(1,-1))),axis = 1)
    state_19 = np.concatenate((np.reshape(se_max_ur[18,0,:],(1,num_ue)),np.reshape(ue_history[18,:],(1,num_ue)),np.reshape(H_rc[18,0,:,:],(1,-1)),np.reshape(H_ic[18,0,:,:],(1,-1))),axis = 1)
    state_20 = np.concatenate((np.reshape(se_max_ur[19,0,:],(1,num_ue)),np.reshape(ue_history[19,:],(1,num_ue)),np.reshape(H_rc[19,0,:,:],(1,-1)),np.reshape(H_ic[19,0,:,:],(1,-1))),axis = 1)

    state_21 = np.concatenate((np.reshape(se_max_ur[20,0,:],(1,num_ue)),np.reshape(ue_history[20,:],(1,num_ue)),np.reshape(H_rc[20,0,:,:],(1,-1)),np.reshape(H_ic[20,0,:,:],(1,-1))),axis = 1)
    state_22 = np.concatenate((np.reshape(se_max_ur[21,0,:],(1,num_ue)),np.reshape(ue_history[21,:],(1,num_ue)),np.reshape(H_rc[21,0,:,:],(1,-1)),np.reshape(H_ic[21,0,:,:],(1,-1))),axis = 1)
    state_23 = np.concatenate((np.reshape(se_max_ur[22,0,:],(1,num_ue)),np.reshape(ue_history[22,:],(1,num_ue)),np.reshape(H_rc[22,0,:,:],(1,-1)),np.reshape(H_ic[22,0,:,:],(1,-1))),axis = 1)
    state_24 = np.concatenate((np.reshape(se_max_ur[23,0,:],(1,num_ue)),np.reshape(ue_history[23,:],(1,num_ue)),np.reshape(H_rc[23,0,:,:],(1,-1)),np.reshape(H_ic[23,0,:,:],(1,-1))),axis = 1)
    state_25 = np.concatenate((np.reshape(se_max_ur[24,0,:],(1,num_ue)),np.reshape(ue_history[24,:],(1,num_ue)),np.reshape(H_rc[24,0,:,:],(1,-1)),np.reshape(H_ic[24,0,:,:],(1,-1))),axis = 1)
    state_26 = np.concatenate((np.reshape(se_max_ur[25,0,:],(1,num_ue)),np.reshape(ue_history[25,:],(1,num_ue)),np.reshape(H_rc[25,0,:,:],(1,-1)),np.reshape(H_ic[25,0,:,:],(1,-1))),axis = 1)
    state_27 = np.concatenate((np.reshape(se_max_ur[26,0,:],(1,num_ue)),np.reshape(ue_history[26,:],(1,num_ue)),np.reshape(H_rc[26,0,:,:],(1,-1)),np.reshape(H_ic[26,0,:,:],(1,-1))),axis = 1)
    state_28 = np.concatenate((np.reshape(se_max_ur[27,0,:],(1,num_ue)),np.reshape(ue_history[27,:],(1,num_ue)),np.reshape(H_rc[27,0,:,:],(1,-1)),np.reshape(H_ic[27,0,:,:],(1,-1))),axis = 1)
    state_29 = np.concatenate((np.reshape(se_max_ur[28,0,:],(1,num_ue)),np.reshape(ue_history[28,:],(1,num_ue)),np.reshape(H_rc[28,0,:,:],(1,-1)),np.reshape(H_ic[28,0,:,:],(1,-1))),axis = 1)
    state_30 = np.concatenate((np.reshape(se_max_ur[29,0,:],(1,num_ue)),np.reshape(ue_history[29,:],(1,num_ue)),np.reshape(H_rc[29,0,:,:],(1,-1)),np.reshape(H_ic[29,0,:,:],(1,-1))),axis = 1)

    state_31 = np.concatenate((np.reshape(se_max_ur[30,0,:],(1,num_ue)),np.reshape(ue_history[30,:],(1,num_ue)),np.reshape(H_rc[30,0,:,:],(1,-1)),np.reshape(H_ic[30,0,:,:],(1,-1))),axis = 1)
    state_32 = np.concatenate((np.reshape(se_max_ur[31,0,:],(1,num_ue)),np.reshape(ue_history[31,:],(1,num_ue)),np.reshape(H_rc[31,0,:,:],(1,-1)),np.reshape(H_ic[31,0,:,:],(1,-1))),axis = 1)
    state_33 = np.concatenate((np.reshape(se_max_ur[32,0,:],(1,num_ue)),np.reshape(ue_history[32,:],(1,num_ue)),np.reshape(H_rc[32,0,:,:],(1,-1)),np.reshape(H_ic[32,0,:,:],(1,-1))),axis = 1)
    state_34 = np.concatenate((np.reshape(se_max_ur[33,0,:],(1,num_ue)),np.reshape(ue_history[33,:],(1,num_ue)),np.reshape(H_rc[33,0,:,:],(1,-1)),np.reshape(H_ic[33,0,:,:],(1,-1))),axis = 1)
    state_35 = np.concatenate((np.reshape(se_max_ur[34,0,:],(1,num_ue)),np.reshape(ue_history[34,:],(1,num_ue)),np.reshape(H_rc[34,0,:,:],(1,-1)),np.reshape(H_ic[34,0,:,:],(1,-1))),axis = 1)
    state_36 = np.concatenate((np.reshape(se_max_ur[35,0,:],(1,num_ue)),np.reshape(ue_history[35,:],(1,num_ue)),np.reshape(H_rc[35,0,:,:],(1,-1)),np.reshape(H_ic[35,0,:,:],(1,-1))),axis = 1)
    state_37 = np.concatenate((np.reshape(se_max_ur[36,0,:],(1,num_ue)),np.reshape(ue_history[36,:],(1,num_ue)),np.reshape(H_rc[36,0,:,:],(1,-1)),np.reshape(H_ic[36,0,:,:],(1,-1))),axis = 1)
    state_38 = np.concatenate((np.reshape(se_max_ur[37,0,:],(1,num_ue)),np.reshape(ue_history[37,:],(1,num_ue)),np.reshape(H_rc[37,0,:,:],(1,-1)),np.reshape(H_ic[37,0,:,:],(1,-1))),axis = 1)
    state_39 = np.concatenate((np.reshape(se_max_ur[38,0,:],(1,num_ue)),np.reshape(ue_history[38,:],(1,num_ue)),np.reshape(H_rc[38,0,:,:],(1,-1)),np.reshape(H_ic[38,0,:,:],(1,-1))),axis = 1)
    state_40 = np.concatenate((np.reshape(se_max_ur[39,0,:],(1,num_ue)),np.reshape(ue_history[39,:],(1,num_ue)),np.reshape(H_rc[39,0,:,:],(1,-1)),np.reshape(H_ic[39,0,:,:],(1,-1))),axis = 1)

    state_41 = np.concatenate((np.reshape(se_max_ur[40,0,:],(1,num_ue)),np.reshape(ue_history[40,:],(1,num_ue)),np.reshape(H_rc[40,0,:,:],(1,-1)),np.reshape(H_ic[40,0,:,:],(1,-1))),axis = 1)
    state_42 = np.concatenate((np.reshape(se_max_ur[41,0,:],(1,num_ue)),np.reshape(ue_history[41,:],(1,num_ue)),np.reshape(H_rc[41,0,:,:],(1,-1)),np.reshape(H_ic[41,0,:,:],(1,-1))),axis = 1)
    state_43 = np.concatenate((np.reshape(se_max_ur[42,0,:],(1,num_ue)),np.reshape(ue_history[42,:],(1,num_ue)),np.reshape(H_rc[42,0,:,:],(1,-1)),np.reshape(H_ic[42,0,:,:],(1,-1))),axis = 1)
    state_44 = np.concatenate((np.reshape(se_max_ur[43,0,:],(1,num_ue)),np.reshape(ue_history[43,:],(1,num_ue)),np.reshape(H_rc[43,0,:,:],(1,-1)),np.reshape(H_ic[43,0,:,:],(1,-1))),axis = 1)
    state_45 = np.concatenate((np.reshape(se_max_ur[44,0,:],(1,num_ue)),np.reshape(ue_history[44,:],(1,num_ue)),np.reshape(H_rc[44,0,:,:],(1,-1)),np.reshape(H_ic[44,0,:,:],(1,-1))),axis = 1)
    state_46 = np.concatenate((np.reshape(se_max_ur[45,0,:],(1,num_ue)),np.reshape(ue_history[45,:],(1,num_ue)),np.reshape(H_rc[45,0,:,:],(1,-1)),np.reshape(H_ic[45,0,:,:],(1,-1))),axis = 1)
    state_47 = np.concatenate((np.reshape(se_max_ur[46,0,:],(1,num_ue)),np.reshape(ue_history[46,:],(1,num_ue)),np.reshape(H_rc[46,0,:,:],(1,-1)),np.reshape(H_ic[46,0,:,:],(1,-1))),axis = 1)
    state_48 = np.concatenate((np.reshape(se_max_ur[47,0,:],(1,num_ue)),np.reshape(ue_history[47,:],(1,num_ue)),np.reshape(H_rc[47,0,:,:],(1,-1)),np.reshape(H_ic[47,0,:,:],(1,-1))),axis = 1)
    state_49 = np.concatenate((np.reshape(se_max_ur[48,0,:],(1,num_ue)),np.reshape(ue_history[48,:],(1,num_ue)),np.reshape(H_rc[48,0,:,:],(1,-1)),np.reshape(H_ic[48,0,:,:],(1,-1))),axis = 1)
    state_50 = np.concatenate((np.reshape(se_max_ur[49,0,:],(1,num_ue)),np.reshape(ue_history[49,:],(1,num_ue)),np.reshape(H_rc[49,0,:,:],(1,-1)),np.reshape(H_ic[49,0,:,:],(1,-1))),axis = 1)
    ...
    while not done:
        ...
        next_state_1 = np.concatenate((np.reshape(se_max_ur[0,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[0,:],(1,num_ue)),np.reshape(H_rc[0,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[0,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_2 = np.concatenate((np.reshape(se_max_ur[1,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[1,:],(1,num_ue)),np.reshape(H_rc[1,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[1,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_3 = np.concatenate((np.reshape(se_max_ur[2,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[2,:],(1,num_ue)),np.reshape(H_rc[2,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[2,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_4 = np.concatenate((np.reshape(se_max_ur[3,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[3,:],(1,num_ue)),np.reshape(H_rc[3,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[3,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_5 = np.concatenate((np.reshape(se_max_ur[4,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[4,:],(1,num_ue)),np.reshape(H_rc[4,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[4,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_6 = np.concatenate((np.reshape(se_max_ur[5,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[5,:],(1,num_ue)),np.reshape(H_rc[5,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[5,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_7 = np.concatenate((np.reshape(se_max_ur[6,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[6,:],(1,num_ue)),np.reshape(H_rc[6,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[6,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_8 = np.concatenate((np.reshape(se_max_ur[7,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[7,:],(1,num_ue)),np.reshape(H_rc[7,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[7,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_9 = np.concatenate((np.reshape(se_max_ur[8,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[8,:],(1,num_ue)),np.reshape(H_rc[8,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[8,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_10 = np.concatenate((np.reshape(se_max_ur[9,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[9,:],(1,num_ue)),np.reshape(H_rc[9,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[9,(episode_steps+1),:,:],(1,-1))),axis = 1)

        next_state_11 = np.concatenate((np.reshape(se_max_ur[10,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[10,:],(1,num_ue)),np.reshape(H_rc[10,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[10,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_12 = np.concatenate((np.reshape(se_max_ur[11,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[11,:],(1,num_ue)),np.reshape(H_rc[11,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[11,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_13 = np.concatenate((np.reshape(se_max_ur[12,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[12,:],(1,num_ue)),np.reshape(H_rc[12,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[12,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_14 = np.concatenate((np.reshape(se_max_ur[13,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[13,:],(1,num_ue)),np.reshape(H_rc[13,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[13,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_15 = np.concatenate((np.reshape(se_max_ur[14,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[14,:],(1,num_ue)),np.reshape(H_rc[14,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[14,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_16 = np.concatenate((np.reshape(se_max_ur[15,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[15,:],(1,num_ue)),np.reshape(H_rc[15,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[15,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_17 = np.concatenate((np.reshape(se_max_ur[16,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[16,:],(1,num_ue)),np.reshape(H_rc[16,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[16,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_18 = np.concatenate((np.reshape(se_max_ur[17,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[17,:],(1,num_ue)),np.reshape(H_rc[17,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[17,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_19 = np.concatenate((np.reshape(se_max_ur[18,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[18,:],(1,num_ue)),np.reshape(H_rc[18,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[18,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_20 = np.concatenate((np.reshape(se_max_ur[19,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[19,:],(1,num_ue)),np.reshape(H_rc[19,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[19,(episode_steps+1),:,:],(1,-1))),axis = 1)

        next_state_21 = np.concatenate((np.reshape(se_max_ur[20,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[20,:],(1,num_ue)),np.reshape(H_rc[20,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[20,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_22 = np.concatenate((np.reshape(se_max_ur[21,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[21,:],(1,num_ue)),np.reshape(H_rc[21,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[21,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_23 = np.concatenate((np.reshape(se_max_ur[22,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[22,:],(1,num_ue)),np.reshape(H_rc[22,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[22,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_24 = np.concatenate((np.reshape(se_max_ur[23,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[23,:],(1,num_ue)),np.reshape(H_rc[23,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[23,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_25 = np.concatenate((np.reshape(se_max_ur[24,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[24,:],(1,num_ue)),np.reshape(H_rc[24,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[24,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_26 = np.concatenate((np.reshape(se_max_ur[25,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[25,:],(1,num_ue)),np.reshape(H_rc[25,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[25,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_27 = np.concatenate((np.reshape(se_max_ur[26,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[26,:],(1,num_ue)),np.reshape(H_rc[26,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[26,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_28 = np.concatenate((np.reshape(se_max_ur[27,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[27,:],(1,num_ue)),np.reshape(H_rc[27,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[27,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_29 = np.concatenate((np.reshape(se_max_ur[28,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[28,:],(1,num_ue)),np.reshape(H_rc[28,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[28,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_30 = np.concatenate((np.reshape(se_max_ur[29,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[29,:],(1,num_ue)),np.reshape(H_rc[29,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[29,(episode_steps+1),:,:],(1,-1))),axis = 1)

        next_state_31 = np.concatenate((np.reshape(se_max_ur[30,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[30,:],(1,num_ue)),np.reshape(H_rc[30,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[30,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_32 = np.concatenate((np.reshape(se_max_ur[31,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[31,:],(1,num_ue)),np.reshape(H_rc[31,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[31,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_33 = np.concatenate((np.reshape(se_max_ur[32,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[32,:],(1,num_ue)),np.reshape(H_rc[32,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[32,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_34 = np.concatenate((np.reshape(se_max_ur[33,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[33,:],(1,num_ue)),np.reshape(H_rc[33,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[33,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_35 = np.concatenate((np.reshape(se_max_ur[34,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[34,:],(1,num_ue)),np.reshape(H_rc[34,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[34,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_36 = np.concatenate((np.reshape(se_max_ur[35,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[35,:],(1,num_ue)),np.reshape(H_rc[35,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[35,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_37 = np.concatenate((np.reshape(se_max_ur[36,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[36,:],(1,num_ue)),np.reshape(H_rc[36,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[36,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_38 = np.concatenate((np.reshape(se_max_ur[37,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[37,:],(1,num_ue)),np.reshape(H_rc[37,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[37,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_39 = np.concatenate((np.reshape(se_max_ur[38,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[38,:],(1,num_ue)),np.reshape(H_rc[38,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[38,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_40 = np.concatenate((np.reshape(se_max_ur[39,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[39,:],(1,num_ue)),np.reshape(H_rc[39,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[39,(episode_steps+1),:,:],(1,-1))),axis = 1)

        next_state_41 = np.concatenate((np.reshape(se_max_ur[40,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[40,:],(1,num_ue)),np.reshape(H_rc[40,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[40,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_42 = np.concatenate((np.reshape(se_max_ur[41,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[41,:],(1,num_ue)),np.reshape(H_rc[41,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[41,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_43 = np.concatenate((np.reshape(se_max_ur[42,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[42,:],(1,num_ue)),np.reshape(H_rc[42,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[42,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_44 = np.concatenate((np.reshape(se_max_ur[43,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[43,:],(1,num_ue)),np.reshape(H_rc[43,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[43,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_45 = np.concatenate((np.reshape(se_max_ur[44,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[44,:],(1,num_ue)),np.reshape(H_rc[44,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[44,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_46 = np.concatenate((np.reshape(se_max_ur[45,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[45,:],(1,num_ue)),np.reshape(H_rc[45,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[45,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_47 = np.concatenate((np.reshape(se_max_ur[46,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[46,:],(1,num_ue)),np.reshape(H_rc[46,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[46,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_48 = np.concatenate((np.reshape(se_max_ur[47,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[47,:],(1,num_ue)),np.reshape(H_rc[47,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[47,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_49 = np.concatenate((np.reshape(se_max_ur[48,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[48,:],(1,num_ue)),np.reshape(H_rc[48,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[48,(episode_steps+1),:,:],(1,-1))),axis = 1)
        next_state_50 = np.concatenate((np.reshape(se_max_ur[49,(episode_steps+1),:],(1,num_ue)),np.reshape(ue_history[49,:],(1,num_ue)),np.reshape(H_rc[49,(episode_steps+1),:,:],(1,-1)),np.reshape(H_ic[49,(episode_steps+1),:,:],(1,-1))),axis = 1)
...
with h5py.File("./data/8_8_infer_50RB_mob_ind.hdf5", "w") as data_file:
