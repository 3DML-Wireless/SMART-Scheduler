...
parser.add_argument('--alpha_lr', type=float, default=0.00005, metavar='G',
...
H_file = h5py.File('./64_128_mob_normal.hdf5','r')
...
for i_episode in range (args.max_episode): 
    ...
    if args.start_steps < total_numsteps and i_episode > 0 and i_episode % args.save_per_epochs == 0:
        agent.save_checkpoint('QuaDriGa_SAC_KNN_64_128_mobile')


with h5py.File("./64_128_vanilla_mobile.hdf5", "w") as data_file:
